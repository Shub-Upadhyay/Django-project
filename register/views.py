...
def signup(request):
    ...
    if email not in emails:
        if password == password1:
            ...
            return HttpResponse('<h1 style="text-align:center;" >You have been Registered</h1> <h3 style="text-align:center;" >Go back to homepage to Login </h3> <a href="/" style="text-decoration: none; color:black; margin-left: 45.5%;  border: 2px solid brown ; padding: 0.5%; " >Click Here for Homepage</a> ')
        else:
